...
import { FileText, Download, ShieldCheck, Scale, Award, Heart, CheckCircle } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col font-sans bg-background">
      ...
      <header className="px-6 h-24 flex items-center justify-between border-b border-border/40 bg-background/90 backdrop-blur-md sticky top-0 z-50">
        ...
        <div className="space-x-4 hidden md:flex">
          ...
          <Link href="/login">
            <Button variant="ghost" className="text-base font-medium text-foreground/80 hover:text-primary hover:bg-secondary/50">Login</Button>
          </Link>
        </div>
      </header>
             ...
             <div className="relative z-10 grid md:grid-cols-[1fr_2fr] gap-8 items-center">
                ...
                <div>
                   ...
                   <p className="text-muted-foreground leading-relaxed mb-4">
                     <strong>Kaká Ribeiro</strong> foi a pioneira a introduzir o conceito <strong>WOLLYING</strong> no Brasil há mais de 20 anos, adaptando metodologias canadenses à realidade social e jurídica brasileira.
                   </p>
                   <p className="text-muted-foreground leading-relaxed">
                     Ela é a <strong>única especialista no país</strong> detentora do Protocolo Integrado de Aplicação do WOLLYING, fundamentado na Lei nº 14.188/2021 (Art. 147-B do Código Penal) e em total conformidade com as exigências de gestão de riscos psicossociais da NR-1.
                   </p>
                </div>
             </div>
          </section>
